...
class get_ijwd:
    ...
    def __init__(self, *param_dict, **kwargs):
        ...
        self.mean_SynNumIn_ee = 320     ; # SynNumOut: same # p = 0.08
        self.mean_SynNumIn_ei = 500     ; # SynNumOut: /4 # p = 0.125
        self.mean_SynNumIn_ie = 200     ; # SynNumOut: *4 # p = 0.2
        self.mean_SynNumIn_ii = 250     ; # SynNumOut: same # p = 0.25
        self.w_ee_mean = 4
        self.w_ei_mean = 5
        self.w_ie_mean = 20
        self.w_ii_mean = 25
        self.delay = 4 # scalar or 2-D array
    ...
    def generate_ijw(self):
        ...
        self.p_peak_ee = self.find_peak_probability(self.mean_SynNumIn_ee, self.decay_p_ee, self.e_lattice, self.width, position=self.e_lattice[0], cnt_type='E-E')
        self.p_peak_ei = self.find_peak_probability(self.mean_SynNumIn_ei, self.decay_p_ei, self.e_lattice, self.width, position=self.i_lattice[0], cnt_type='E-I')
        self.p_peak_ie = self.find_peak_probability(self.mean_SynNumIn_ie, self.decay_p_ie, self.i_lattice, self.width, position=self.e_lattice[0], cnt_type='I-E')
        self.p_peak_ii = self.find_peak_probability(self.mean_SynNumIn_ii, self.decay_p_ii, self.i_lattice, self.width, position=self.i_lattice[0], cnt_type='I-I')
    ...
    def generate_d_dist(self):
        # self.delay: 2-D array, range of delay distribution
    ...
    # WTF delays are not uniform distributed?
