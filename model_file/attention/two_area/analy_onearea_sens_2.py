...
# -*- coding: utf-8 -*-
"""
Created on Wed Feb  3 14:34:36 2021
...
data.a1.ge.get_MSD(start_time=5000, end_time=20000, n_neuron = data.a1.param.Ne, \
                   ...
                   window = 10, jump_interval=np.arange(1,1000,5), fit_stableDist='Matlab')
...
stim = [[[[31.5,31.5],[64,0]], [stim_on_off,stim_on_off], [[6]*stim_on_off.shape[0],[6]*stim_on_off.shape[0]]]]
