...
# -*- coding: utf-8 -*-
"""
Created on Wed Dec  9 12:10:39 2020
...
dt = 1/10000;
end = int(6/dt); start = int(2/dt)
spon_rate1 = np.sum((data.a1.ge.t < end) & (data.a1.ge.t > start))/4/data.a1.param.Ne
spon_rate2 = np.sum((data.a2.ge.t < end) & (data.a2.ge.t > start))/4/data.a2.param.Ne
...
#                                         show_pattern_size=True, pattern_ctr=data.a1.ge.centre_mass.centre_ind, \
#                                             pattern_size=pattern_size2)
ani = firing_rate_analysis.show_pattern(data.a1.ge.spk_rate.spk_rate, data.a1.gi.spk_rate.spk_rate, frames = frames, start_time = start_time, \
                                        interval_movie=20, anititle=title, show_pattern_size=False)
