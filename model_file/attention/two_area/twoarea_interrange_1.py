...
# -*- coding: utf-8 -*-
"""
Created on Sat Jul  3 15:38:50 2021
                ...
                for new_delta_gk_2 in [0.5]:#np.arange(0.5, 2.1, 0.5):#[2]:#np.arange(0.15,0.31,0.05)*delta_gk_:#np.linspace(1,5,5):
                    for tau_s_di_ in np.linspace(4.4,4.4,1):
                        for tau_s_de_ in np.linspace(5.,5.,1):
                            ...
                            for scale_w_12_e in np.arange(1.5, 2.01, 0.2):#np.arange(0.8,1.21,0.05):[2.5]
                                for scale_w_12_i in scale_w_12_e*np.array([1]):#np.array([0.8,0.9,1.0,1.1]):#np.arange(0.9,1.11,0.1):#np.arange(0.8,1.21,0.05):#[scale_w_12_e]:#0.2*np.arange(0.8,1.21,0.05):
                                    for scale_w_21_e in np.arange(0.4, 0.701, 0.05):#np.arange(0.8,1.21,0.05):#[1]:#np.arange(0.8,1.21,0.05):[0.3]
                                                        ...
                                                        for tau_p_d_e2_i1 in [tau_p_d_e2_e1]:#[15]:#np.arange(7,14.1,1):#[10]:
                                                            for peak_p_e1_e2 in [0.5]:#np.arange(0.3,0.451,0.05):
                                                                for peak_p_e1_i2 in [0.5]:#np.arange(0.25,0.401,0.05):
                                                                    for peak_p_e2_e1 in [0.5]:#[0.1,0.12,0.14]:#np.arange(0.10):#[0.15]: # 0.18
                                                                        for peak_p_e2_i1 in [0.5]:#peak_p_e2_e1*np.repeat(np.arange(0.9,1.1,0.03),repeat):#:[0.15]*repeat: # 0.18
...
ijwd_inter.p_inter_area_1 = 1; ijwd_inter.p_inter_area_2 = 1
...
for i in range(n_StimAmp):
    stim_amp_scale[i*n_perStimAmp:i*n_perStimAmp+n_perStimAmp] = 2**(i+1)

stim_scale_cls.stim_amp_scale = stim_amp_scale
stim_scale_cls.stim_dura = 1000
...
stim_scale_cls_att.stim_amp_scale = stim_amp_scale
stim_scale_cls_att.stim_dura = 1000
