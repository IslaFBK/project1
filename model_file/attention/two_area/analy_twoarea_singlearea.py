...
# -*- coding: utf-8 -*-
"""
Created on Fri Feb 12 16:00:25 2021
...
#%%
title = 'two'
title_sens = title + '_sens'
title_asso = title + '_asso'
...
title = title + '_1hz%.2f_2hz%.2f'%(spon_rate1,spon_rate2)
# '''pattern size'''
...
'''fft'''
mua_loca = [0,0]#mua_loca_all[mua_loc_ind]
mua_range = 5 
...
data_anly.pkf_spon_a2 = peakF_spon
...
data_anly.pkf_adapt_a2 = peakF_adapt
