...
# -*- coding: utf-8 -*-
"""
Created on Fri Feb 12 15:14:32 2021
                ...
                for tau_s_di_ in np.linspace(4.4,4.4,1):
                    for tau_s_de_ in np.linspace(5.,5.,1):
                        for tau_s_r_ in [1]:#np.linspace(1,1,1):
                            for scale_w_12_e in np.array([0]):#np.arange(0.8,1.21,0.05):
                                for scale_w_12_i in np.array([0]):#np.arange(0.8,1.21,0.05):#[scale_w_12_e]:#0.2*np.arange(0.8,1.21,0.05):
                                    for scale_w_21_e in [0]:#np.arange(0.8,1.21,0.05):#[1]:#np.arange(0.8,1.21,0.05):
                                        for scale_w_21_i in [0]:#np.arange(0.8,1.21,0.05):#[1]:#[scale_w_21_e]:#0.35*np.arange(0.8,1.21,0.05):
...
simu_time1 = 20000*ms#(stim_scale_cls.stim_on[99,1] + 2000)*ms
