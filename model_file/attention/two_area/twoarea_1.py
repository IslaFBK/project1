...
# -*- coding: utf-8 -*-
"""
Created on Wed Dec  9 11:48:40 2020
                                                ...
                                                for tau_s_de_ in np.linspace(5.,5.,1):
                                                    for tau_s_r_ in [1]:#np.linspace(1,1,1):
                                                        for scale_w_12_e in np.arange(0.8,1.21,0.05):
                                                            for scale_w_12_i in [scale_w_12_e]:#0.2*np.arange(0.8,1.21,0.05):
                                                                for scale_w_21_e in np.arange(0.8,1.21,0.05):
                                                                    for scale_w_21_i in [scale_w_21_e]:#0.35*np.arange(0.8,1.21,0.05):
                                                                        for peak_p_e1_e2 in [0.65]:#np.arange(0.3,0.451,0.05):
                                                                            for peak_p_e1_i2 in [0.3]:#np.arange(0.25,0.401,0.05):
...
ijwd_inter.peak_p_e1_e2 = peak_p_e1_e2; ijwd_inter.tau_p_d_e1_e2 = 5
ijwd_inter.peak_p_e1_i2 = peak_p_e1_i2; ijwd_inter.tau_p_d_e1_i2 = 7        
...
ijwd_inter.w_e2_e1_mean = 7*scale_w_21_e; ijwd_inter.w_e2_i1_mean = 9.6*scale_w_21_i
