...
# -*- coding: utf-8 -*-
"""
Created on Mon Mar 15 13:22:47 2021

@author: shni2598
"""


'''if firing rate saturates as input increase'''
...
for ie_r_e in [2.76*6.5/5.8]:# np.linspace(3.07,3.13,7):#np.arange(2.5,4.0,0.04):#[3.1]:#np.linspace(3.10,3.45,6):#np.linspace(1.4,1.6,10):#[1.5]: #np.linspace(1.,1.2,5):
    for ie_r_e1 in np.arange(1.4,1.611,0.02):
        for w_ee_ in [None]:#[4]:
...
onearea_net = build_one_area_t.one_area()
...
group_i_1.C = 0.167*nF # 0.25*nF
group_i_1.g_l = 16.7*nS
group_i_1.t_ref = t_ref_*ms
