...
# -*- coding: utf-8 -*-
"""
Created on Fri Mar 19 13:30:58 2021
                        ...
                        for tau_s_r_ in [1]:#np.linspace(1,1,1):
                            for scale_w_12_e in [2.5]:#np.arange(1.6, 2.01, 0.05):#np.arange(0.8,1.21,0.05):
                                for scale_w_12_i in scale_w_12_e*np.array([1]):#np.array([0.8,0.9,1.0,1.1]):#np.arange(0.9,1.11,0.1):#np.arange(0.8,1.21,0.05):#[scale_w_12_e]:#0.2*np.arange(0.8,1.21,0.05):
                                    for scale_w_21_e in np.arange(0.35, 0.45, 0.02):#np.arange(0.8,1.21,0.05):#[1]:#np.arange(0.8,1.21,0.05):[0.3]
                                        for scale_w_21_i in scale_w_21_e*np.array([0.95]):#np.arange(0.9,1.11,0.1):#np.arange(0.8,1.21,0.05):#[1]:#[scale_w_21_e]:#0.35*np.arange(0.8,1.21,0.05):
                                            for tau_p_d_e1_e2 in [5]:
                                                for tau_p_d_e1_i2 in [5]:
                                                    for tau_p_d_e2_e1 in [13,15,17]:#np.arange(7,14.1,1):
                                                        for tau_p_d_e2_i1 in [13,15,17]:#np.arange(7,14.1,1):#[10]:
