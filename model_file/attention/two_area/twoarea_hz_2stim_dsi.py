...
# -*- coding: utf-8 -*-
"""
Created on Thu Mar 25 17:55:20 2021
...
for ie_r_e1 in 1.56*np.linspace(0.85,1.15,5):#np.arange(1.44, 1.68, 0.05):
    for ie_r_i1 in 1.482*ie_r_e1/1.56*np.linspace(0.9, 1.1, 3):#[1.40]:
        #for w_extnl_ in [10]:
        for delta_gk_1 in [3.5]:#np.linspace(7,15,9)]]:
            for delta_gk_2 in [16]:
                for new_delta_gk_2 in [2]:#np.arange(0.15,0.31,0.05)*delta_gk_:#np.linspace(1,5,5):
                    for tau_s_di_ in np.linspace(3.6,6.5,6):
