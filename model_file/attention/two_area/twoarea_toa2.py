...
# -*- coding: utf-8 -*-
"""
Created on Mon Dec  7 12:32:17 2020
                                            ...
                                            for tau_s_di_ in np.linspace(4.4,4.4,1):
                                                for tau_s_de_ in np.linspace(5.,5.,1):
                                                    for tau_s_r_ in [1]:#np.linspace(1,1,1):
                                                        for scale_w_12_e in 0.2*np.arange(0.8,1.21,0.05):
                                                            for scale_w_12_i in 0.2*np.arange(0.8,1.21,0.05):
                                                                for scale_w_21_e in [0]:#0.35*np.arange(0.8,1.21,0.05):
                                                                    for scale_w_21_i in [0]:#0.35*np.arange(0.8,1.21,0.05):
                                                                        for peak_p_e1_e2 in [0.65]:#np.arange(0.3,0.451,0.05):
                                                                            for peak_p_e1_i2 in np.arange(0.25,0.401,0.05):
