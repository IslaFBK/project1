...
# -*- coding: utf-8 -*-
"""
Created on Sat Jul  3 12:49:09 2021
                                ...
                                for scale_w_12_i in scale_w_12_e*np.array([1]):#np.array([0.8,0.9,1.0,1.1]):#np.arange(0.9,1.11,0.1):#np.arange(0.8,1.21,0.05):#[scale_w_12_e]:#0.2*np.arange(0.8,1.21,0.05):
                                    for scale_w_21_e in np.arange(0.30, 0.31, 0.02):#np.arange(0.8,1.21,0.05):#[1]:#np.arange(0.8,1.21,0.05):[0.3]
                                        for scale_w_21_i in scale_w_21_e*np.array([1]):#np.arange(0.9,1.11,0.1):#np.arange(0.8,1.21,0.05):#[1]:#[scale_w_21_e]:#0.35*np.arange(0.8,1.21,0.05):
                                            for tau_p_d_e1_e2 in [3]:
                                                for tau_p_d_e1_i2 in [3]:
                                                    for tau_p_d_e2_e1 in [3]:#np.arange(7,14.1,1):
                                                        for tau_p_d_e2_i1 in [tau_p_d_e2_e1]:#[15]:#np.arange(7,14.1,1):#[10]:
                                                            for peak_p_e1_e2 in [1]:#np.arange(0.3,0.451,0.05):
                                                                for peak_p_e1_i2 in [1]:#np.arange(0.25,0.401,0.05):
                                                                    for peak_p_e2_e1 in [1]:#[0.1,0.12,0.14]:#np.arange(0.10):#[0.15]: # 0.18
                                                                        for peak_p_e2_i1 in [1]:#peak_p_e2_e1*np.repeat(np.arange(0.9,1.1,0.03),repeat):#:[0.15]*repeat: # 0.18
...
ijwd_inter.p_inter_area_1 = 0.5; ijwd_inter.p_inter_area_2 = 0.5
...
#i=ijwd_inter.i_e1_e2, j=ijwd_inter.j_e1_e2
targ = ijwd_inter.e_lattice2[ijwd_inter.j_e1_e2[ijwd_inter.i_e1_e2 == 2080]]
plt.plot(targ[:,0], targ[:,1], 'o')
plt.xlim([-32,32])
plt.ylim([-32,32])
#%%
plt.figure()
...
#i=ijwd_inter.i_e1_e2, j=ijwd_inter.j_e1_e2
targ = ijwd_inter.i_lattice2[ijwd_inter.j_e1_i2[ijwd_inter.i_e1_i2 == 2083]]
plt.plot(targ[:,0], targ[:,1], 'o')
plt.xlim([-32,32])
plt.ylim([-32,32])
#%%
...
#i=ijwd_inter.i_e1_e2, j=ijwd_inter.j_e1_e2
targ = ijwd_inter.e_lattice1[ijwd_inter.j_e2_e1[ijwd_inter.i_e2_e1 == 2080]]
plt.plot(targ[:,0], targ[:,1], 'o')
plt.xlim([-32,32])
plt.ylim([-32,32])
#%%
...
#i=ijwd_inter.i_e1_e2, j=ijwd_inter.j_e1_e2
targ = ijwd_inter.i_lattice1[ijwd_inter.j_e2_i1[ijwd_inter.i_e2_i1 == 2080]]
plt.plot(targ[:,0], targ[:,1], 'o')
plt.xlim([-32,32])
plt.ylim([-32,32])
#%%
