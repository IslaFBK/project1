...
# -*- coding: utf-8 -*-
"""
Created on Mon Mar 29 12:31:25 2021
...
syn_e1e2, syn_e1i2, syn_e2e1, syn_e2i1 = twoarea_net.build(ijwd1, ijwd2, ijwd_inter, adapt_modu_1 = False, adapt_modu_2 = True)
#%%
...
stim_scale_cls.stim_dura = 3000
stim_scale_cls.separate_dura = np.array([400,700])
...
dgk_modu_on = TimedArray(dgk_modu, dt=10*ms)
#%%
...
simu_time1 = simu_time_tot #(stim_scale_cls.stim_on[n_StimAmp*n_perStimAmp-1,1] + 2000)*ms
