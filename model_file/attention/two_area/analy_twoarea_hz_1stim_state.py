...
# -*- coding: utf-8 -*-
"""
Created on Tue Apr  6 17:04:28 2021
...
savefile_name = 'data_anly_nc_normal' #'data_anly' data_anly_temp
save_apd = '_nc_normal'

fftplot = 0; getfano = 0
get_nscorr = 1; get_nscorr_t = 0
...
if get_nscorr_t:
    ...
    for win in win_lst:
        ...
        savetitle = title.replace('\n','')
        nsfile = savetitle+'_nct_win%.1f_%d'%(win,loop_num)+'.png'
        if save_img: fig.savefig(nsfile)
        plt.close()
#%%
'''firing rate'''
