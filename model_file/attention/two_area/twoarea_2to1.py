...
# -*- coding: utf-8 -*-
"""
Created on Sun Jan 10 22:28:35 2021
                        ...
                        for tau_s_r_ in [1]:#np.linspace(1,1,1):
                            for scale_w_12_e in np.array([1.2]):#np.arange(0.8,1.21,0.05):
                                for scale_w_12_i in np.array([1.2]):#np.arange(0.8,1.21,0.05):#[scale_w_12_e]:#0.2*np.arange(0.8,1.21,0.05):
                                    for scale_w_21_e in np.arange(0.8,1.21,0.05):#[1]:#np.arange(0.8,1.21,0.05):
                                        for scale_w_21_i in np.arange(0.8,1.21,0.05):#[1]:#[scale_w_21_e]:#0.35*np.arange(0.8,1.21,0.05):
...
inter_time = 4000
suplmt = (inter_time // stim_scale_cls.dt_stim) - (stim_scale_cls.scale_stim.shape[0] - stim_scale_cls.stim_on[-1,1] // stim_scale_cls.dt_stim)
...
simu_time1 = (stim_scale_cls.stim_on[29,1] + 2000)*ms
