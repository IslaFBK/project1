...
# -*- coding: utf-8 -*-
"""
Created on Sat Mar 13 12:09:09 2021
                                                        ...
                                                        for tau_p_d_e2_i1 in [10]:#np.arange(7,14.1,1):#[10]:
                                                            for peak_p_e1_e2 in [0.6]:#np.arange(0.3,0.451,0.05):
                                                                for peak_p_e1_i2 in [0.6]:#np.arange(0.25,0.401,0.05):
                                                                    for peak_p_e2_e1 in np.arange(0.10,0.26,0.05):#[0.15]: # 0.18
                                                                        for peak_p_e2_i1 in peak_p_e2_e1*np.repeat(np.arange(0.9,1.1,0.03),repeat):#:[0.15]*repeat: # 0.18
