...
# -*- coding: utf-8 -*-
"""
Created on Thu Mar 26 10:15:02 2020

@author: shni2598
"""
'''
add two input stimuli into sensory area. The input fring rate have Gaussian profile 
sensory area: asynchronous region; association area: working region; 
'''
...
dir_cache = '/headnode1/shni2598/brian2/brian_cache2/cache%s' %sys.argv[1]
