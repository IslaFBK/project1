...
#%%
savename = (spke1.param['adpt_range'], spke1.param['new_delta_gk'], \
...
matcmd = "saveas(gcf, 'wvt_{:d}_{:.1f}_{:.1f}_{:.1f}_{:.1f}_{:.3f}_{:d}.png')".format(*savename)
...
#%%
fig.savefig('fftrate_chg_adapt_%d_%.1f_%.1f_%.1f_%.1f_%.3f_%d.png'%savename)
#%%
#plt.figure()
