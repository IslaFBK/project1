# -*- coding: utf-8 -*-
"""
Created on Thu Jul 30 20:17:37 2020
...
syn_extnl_e = Synapses(extnl_input_e, group_e_2, method='euler', on_pre='x_post += 1/tau_x_re')
syn_extnl_i = Synapses(extnl_input_i, group_i_2, method='euler', on_pre='x_post += 1/tau_x_re')
