...
# -*- coding: utf-8 -*-
"""
Created on Sat Aug  1 12:12:35 2020
...
w_extnl: siemens
ds_extnl/dt = -s_extnl/tau_s_de_extnl + rect_puls_n : 1
rect_puls_n = (1/tau_x_re)*effect_n : Hz
effect_n : integer
...
syn_extnl_e = Synapses(extnl_input_e, group_e_2, method='euler', \
                       on_pre={'up':'effect_n_post += 1', 'down': 'effect_n_post -= 1'})
syn_extnl_i = Synapses(extnl_input_i, group_i_2, method='euler', \
                       on_pre={'up':'effect_n_post += 1', 'down': 'effect_n_post -= 1'})
...
group_e_2.effect_n = 0
group_i_2.effect_n = 0
...
syn_extnl_e = set_delay(syn_extnl_e, 0)
syn_extnl_i = set_delay(syn_extnl_i, 0)
...
group_e_2.delta_gk = delta_gk*nS
...
group_e_2.I_extnl = 0.0*nA
group_i_2.I_extnl = 0.0*nA
...
param = {'chg_adapt_time':'2s','delta_gk':delta_gk,'new_delta_gk':2,'new_tau_k':40,'tau_s_di':6.0,\
         'tau_s_de':5.0, 'ie_ratio':3.375, 'chg_adapt_range':6, 'p_ee':0.08}
