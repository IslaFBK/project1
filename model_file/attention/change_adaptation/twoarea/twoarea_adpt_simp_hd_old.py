# -*- coding: utf-8 -*-
"""
Created on Fri Jun 12 14:23:12 2020
...
prefs.codegen.max_cache_dir_size = 60
#%%poisson_stimuli
print('start run')
Ne = 63*63
Ni = 1024
width = 62
delay_v1v2 = [8,10] # spike transmission delay between two areas
...
lattice_in_1 = cn.quasi_lattice.lattice(width, Ni, [0, 0])
lattice_in_2 = cn.quasi_lattice.lattice(width, Ni, [0, 0])
...
group_input = PoissonGroup(ijwd1.Ne, psti.input_spkrate(maxrate = 600, sig=6, position=[[-31.5, -31.5],[0, 0]])*Hz)
...
syn_ee_v1.effect = 0; syn_ee_v1.tau_s_de = 5*ms
syn_ie_v1.effect = 0; syn_ie_v1.tau_s_di = 3*ms
syn_ei_v1.effect = 0; syn_ei_v1.tau_s_de = 5*ms
syn_ii_v1.effect = 0; syn_ii_v1.tau_s_di = 3*ms
#syn_pois_e.effect = 0
#syn_pois_i.effect = 0
...
group_e_v1.delta_gk = 10*nS
group_e_v1.tau_k = 80*ms
group_e_v1.tau_s_de_extnl = 5*ms
...
syn_ee_v2.effect = 0; syn_ee_v2.tau_s_de = 4.0*ms
syn_ie_v2.effect = 0; syn_ie_v2.tau_s_di = 3.5*ms
syn_ei_v2.effect = 0; syn_ei_v2.tau_s_de = 4.0*ms
syn_ii_v2.effect = 0; syn_ii_v2.tau_s_di = 3.5*ms
...
group_e_v2.delta_gk = 12*nS
group_e_v2.tau_k = 80*ms
group_e_v2.tau_s_de_extnl = 5*ms
...
group_e_v2.delta_gk[chg_adapt_neuron] = 2*nS; group_e_v2.tau_k[chg_adapt_neuron] = 40*ms
...
#%%
spk_v1_tstep = np.round(spk_v1.t/(0.1*ms)).astype(int)
spk_v2_tstep = np.round(spk_v2.t/(0.1*ms)).astype(int)

param_v1 = {'delta_gk':10,'tau_s_di':3,'tau_s_de':5,'ie_ratio':3.1725,'sti_onset':'10s'}

param_v2 = {'chg_adapt_time':'2s','delta_gk':12,'new_delta_gk':2,'new_tau_k':40,'tau_s_di':3.5,\
         'tau_s_de':4.0, 'ie_ratio':2.880, 'chg_adapt_range':6}

param_v1v2 = {'scale_e_12':scale_e_12[i], 'scale_e_21':scale_e_21[j]}

data = {'param':param_v1v2, 'a1':{'param':param_v1,'e':{'i':spk_v1.i[:],'t':spk_v1_tstep}},
                            'a2':{'param':param_v2,'e':{'i':spk_v2.i[:],'t':spk_v2_tstep}}}
