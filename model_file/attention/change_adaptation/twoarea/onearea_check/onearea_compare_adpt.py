# -*- coding: utf-8 -*-
"""
Created on Tue Jun 30 12:47:14 2020
...
if loop_num > 29:
    ...
    net.run(simu_time2, report = 'text', profile=False) 

else:
    simu_time1 = 15000*ms#2000*ms
    #simu_time2 = 8000*ms#8000*ms
    #simu_time3 = 2000*ms
