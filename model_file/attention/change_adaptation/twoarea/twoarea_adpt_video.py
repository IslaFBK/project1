...
timepath = '/import/headnode1/shni2598/brian2/data/twoarea_chg_adapt/timev%d%s.mat'#%(area,file_num)
indexpath = '/import/headnode1/shni2598/brian2/data/twoarea_chg_adapt/indexv%d%s.mat'##%(area,file_num)
