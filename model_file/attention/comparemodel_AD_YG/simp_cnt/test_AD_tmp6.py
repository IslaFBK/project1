...
# -*- coding: utf-8 -*-
"""
Created on Tue Nov  3 16:06:57 2020
...
#param_in = [[0.08,6.5]]
#repeat = 10
for scale_d_p_ee in np.linspace(0.85,1.15,13):#[1]:#
    for scale_d_p_ei in [1]:#np.linspace(0.85,1.15,13):#[1]
        for scale_d_p_ii in [1]:#np.linspace(0.85,1.15,15):
            for scale_d_p_ie in [1]:#np.linspace(0.85,1.15,13):
                for num_ee in np.linspace(125, 297, 10,dtype=int): #[200]:
                    for num_ei in [320]: #np.linspace(204, 466, 10, dtype=int):#              
