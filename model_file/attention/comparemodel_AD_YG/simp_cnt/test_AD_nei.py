...
# -*- coding: utf-8 -*-
"""
Created on Tue Nov 10 23:10:02 2020
        ...
        for scale_d_p_ii in np.linspace(1,1,1):
            for scale_d_p_ie in np.linspace(1,1,1):#np.linspace(0.85,1.15,13):
                for num_ee in [260]:#np.linspace(220,290,8):#[260]:#np.linspace(125, 297, 10,dtype=int): 
                    for num_ei in np.linspace(360,440,9):#[400]:#np.linspace(204, 466, 10, dtype=int):#[320]:               
                        for num_ie in [175]:#[260]:#np.linspace(246, 300, 6,dtype=int):#[221]:#np.linspace(156, 297, 10,dtype=int):
                            for num_ii in [260]:#np.linspace(220,300,9):#[260]:#np.linspace(135, 170,6,dtype=int):#[129]:#np.linspace(93, 177, 10,dtype=int):
                                for ie_r_e in [3.24]:#np.arange(3.05,3.36,0.05):#np.linspace(1.4,1.6,10):#[1.5]: #np.linspace(1.,1.2,5):
                                    for w_ee_ in [4.15]:
                                        for w_ie_ in [20]:#np.linspace(17,23,7):#np.linspace(1.077,1.277,10):#[1.177]:#np.linspace(1,1,1):
                                            for w_ei_ in [4.438]:#np.linspace(2.5,3.0,15):#np.linspace(1.156-0.08,1.156+0.08,15):#np.linspace(1.156-0.175,1.156+0.175,31):#np.linspace(1.157,1.357,10):#[1.257]: #np.linspace(0.95,1.1,5):
                                                for w_ii_ in [20]:#np.linspace(20,27,8):#np.arange(1.4,1.81,0.1)]]:#np.linspace(1.,1.,1):
                                                    for ie_r_i in np.arange(2.8,3.11,0.05):
                                                        for w_extnl_ in [1.5]:
...
ijwd.w_ei_mean = find_w_e(w_ii_, num_ii, num_ei, ie_r_i) #w_ei_
ijwd.w_ie_mean = w_ie_
ijwd.w_ii_mean = w_ii_ #find_w_i(w_ei, num_ei, num_ii, ie_r_i) #w_ii_
