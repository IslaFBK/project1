...
# -*- coding: utf-8 -*-
"""
Created on Thu Nov  5 11:49:12 2020
...
for scale_d_p_ee in [1]:#np.linspace(0.85,1.15,13):
    for scale_d_p_ei in [1]:#np.linspace(0.85,1.15,13):#[1]
        for scale_d_p_ii in np.linspace(1.05,1.2,6):
            for scale_d_p_ie in np.linspace(1.05,1.2,6):#np.linspace(0.85,1.15,13):
                for num_ee in [200]:#np.linspace(125, 297, 10,dtype=int): 
                    for num_ei in [320]:#np.linspace(204, 466, 10, dtype=int):#[320]:               
                        for num_ii in np.linspace(230, 323, 8,dtype=int):#[221]:#np.linspace(156, 297, 10,dtype=int):
                            for num_ie in np.linspace(135, 172, 8,dtype=int):#[129]:#np.linspace(93, 177, 10,dtype=int):
                                for scale_ee_1 in [1.2]:#np.linspace(1.4,1.6,10):#[1.5]: #np.linspace(1.,1.2,5):
                                    for scale_ei_1 in [1.27]:#np.linspace(1.077,1.277,10):#[1.177]:#np.linspace(1,1,1):
                                        for scale_ie_1 in np.linspace(1.156-0.08,1.156+0.08,15):#np.linspace(1.156-0.175,1.156+0.175,31):#np.linspace(1.157,1.357,10):#[1.257]: #np.linspace(0.95,1.1,5):
...
#seed(10)
simu_time1 = 14000*ms#2000*ms
simu_time2 = 10000*ms
#simu_time2 = 2000*ms#8000*ms
#simu_time3 = 1000*ms
simu_time_tot = 24000*ms
