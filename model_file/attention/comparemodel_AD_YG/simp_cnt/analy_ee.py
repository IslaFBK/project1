...
# -*- coding: utf-8 -*-
"""
Created on Sat Nov  7 20:33:35 2020
...
spon_rate_good = spon_rate < 10 and spon_rate > 3.5
'''MSD'''
...
stable_good = data.a1.ge.MSD.stableDist_param[0,0] < 1.75 and data.a1.ge.MSD.stableDist_param[0,0] > 1.35
