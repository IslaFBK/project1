...
# -*- coding: utf-8 -*-
"""
Created on Mon Nov  9 12:10:53 2020
...
ijwd.mean_SynNumIn_ee = 260#200 320 * 6/8 * 1   ; # p = 0.08                          200
ijwd.mean_SynNumIn_ei = 400#500 500 #500 * 1      #500 #* 8/5     ; # p = 0.125       320  
ijwd.mean_SynNumIn_ie = 175#125 200 * 5/8     ; # p = 0.2                             129
...
scale_ee = 1.0#1.05;                                                                
scale_ei = 1.07 #1.
scale_ie = 0.85 #1.115 1.13 0.95 1.07                             #0.87          0.97
scale_ii = 0.95   #1.00            0.89                          #0.83
...
coef, freq = fa.myfft(mua_adpt[1000:2000], 1000)
freq_max = 20
