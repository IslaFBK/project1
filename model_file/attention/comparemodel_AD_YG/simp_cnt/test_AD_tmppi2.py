...
# -*- coding: utf-8 -*-
"""
Created on Thu Nov  5 15:48:08 2020
...
for scale_d_p_ee in [1]:#np.linspace(0.85,1.15,13):
    for scale_d_p_ei in [1]:#np.linspace(0.85,1.15,13):#[1]
        for scale_d_p_ii in np.linspace(1.1,1.2,4):
            for scale_d_p_ie in np.linspace(1.1,1.2,4):#np.linspace(0.85,1.15,13):
                for num_ee in [200]:#np.linspace(125, 297, 10,dtype=int): 
                    for num_ei in [320]:#np.linspace(204, 466, 10, dtype=int):#[320]:               
                        for num_ii in np.linspace(246, 300, 6,dtype=int):#[221]:#np.linspace(156, 297, 10,dtype=int):
                            for num_ie in np.linspace(135, 170,6,dtype=int):#[129]:#np.linspace(93, 177, 10,dtype=int):
