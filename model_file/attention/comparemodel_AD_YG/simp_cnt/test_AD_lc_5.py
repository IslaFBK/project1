...
# -*- coding: utf-8 -*-
"""
Created on Fri Nov  6 12:52:47 2020
...
for scale_ee_1 in [1.200]:#np.arange(1,1.26,0.05):#[1.15]: #np.linspace(1.,1.2,5):
    for scale_ei_1 in [1.27]:#np.linspace(1,1,1):
        for scale_ie_1 in [1.15]:#np.arange(0.9825,1.1225,0.02):#[1.0625]: #np.linspace(0.95,1.1,5):
...
ijwd.decay_p_ie = 20*0.86 #scale_d_p # decay constant of i to e connection probability as distance increases
ijwd.decay_p_ii = 20*0.86 #scale_d_p # decay constant of i to i connection probability as distance increases

ijwd.mean_SynNumIn_ee = 200#200 320 * 6/8 * 1   ; # p = 0.08                          200
ijwd.mean_SynNumIn_ei = 320#500 500 #500 * 1      #500 #* 8/5     ; # p = 0.125       320  
ijwd.mean_SynNumIn_ie = 129#125 200 * 5/8     ; # p = 0.2                             129
ijwd.mean_SynNumIn_ii = 221#250 250 * 1    # 250 * 8/5     ; # p = 0.25               221  
...
scale_ee = 1.0#1.05; 
scale_ei = 1.0 #1.
scale_ie = 0.89 #1.115 1.13 0.95 1.07
scale_ii = 1.2   #1.00            0.89
