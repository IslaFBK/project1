...
# -*- coding: utf-8 -*-
"""
Created on Sun Nov  1 23:37:49 2020
...
for scale_ee_1 in [1.2]:#np.linspace(1.4,1.6,10):#[1.5]: #np.linspace(1.,1.2,5):
    for scale_ei_1 in [1.27]:#np.linspace(1.077,1.277,10):#[1.177]:#np.linspace(1,1,1):
        for scale_ie_1 in np.linspace(1.213-0.2,1.213+0.2,31):#np.linspace(1.157,1.357,10):#[1.257]: #np.linspace(0.95,1.1,5):
            for scale_ii_1 in [1.082]:#np.arange(1.4,1.81,0.1)]]:#np.linspace(1.,1.,1):
                for w_extnl_ in [1.5]:
...
ijwd.decay_p_ie = decay_p_ie_p_ii * 0.86#* scale_d_p # decay constant of i to e connection probability as distance increases
ijwd.decay_p_ii = decay_p_ie_p_ii * 0.86#* scale_d_p # decay constant of i to i connection probability as distance increases

ijwd.mean_SynNumIn_ee = 200     ; # p = 0.08
ijwd.mean_SynNumIn_ei = 320 #* 8/5     ; # p = 0.125
ijwd.mean_SynNumIn_ie = 129     ; # p = 0.2
ijwd.mean_SynNumIn_ii = 221 #* 8/5     ; # p = 0.25
