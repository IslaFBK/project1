...
# -*- coding: utf-8 -*-
"""
Created on Tue Oct 27 11:55:21 2020
...
title = "ie%.3f_dse%.3f_dgk%.1f_alpha%.2f_hz%.2f"%(data.a1.param.scale_ie_1, data.a1.param.tau_s_de, data.a1.param.delta_gk, data.a1.ge.MSD.stableDist_param[0,0], spon_rate)
