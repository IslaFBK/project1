...
# -*- coding: utf-8 -*-
"""
Created on Fri Nov 13 11:49:25 2020
...
spon_rate = np.sum((data.a1.ge.t < end) & (data.a1.ge.t > start))/10/data.a1.param.Ne
...
"""
'''MSD'''
data.a1.ge.get_MSD(start_time=4000, end_time=14000, n_neuron=data.a1.param.Ne, window = 15, jump_interval=np.array([15]), fit_stableDist='pylevy')
...
if analy_type == 'YG':
    #data_anly.invalid_pei = data.a1.param.p_peak_ei >= 1    
    title = "cn%.1f_erie%.3f_\non%.2f_sz%.1f_alpha%.2f_hz%.2f"%(data.a1.param.cn, data.a1.param.ie_ratio,\
                                                      data_anly.pattern_on_ratio, data_anly.patterns_size_mean,\
                                                      data.a1.ge.MSD.stableDist_param[0,0],spon_rate)    
