...
# -*- coding: utf-8 -*-
"""
Created on Fri Oct 16 17:30:01 2020
...
title = "dgk{:.1f}_ndgk{:.1f}_alpha{:.2f}_hz{:.2f}".format(data.a1.param.delta_gk,data.a1.param.new_delta_gk,data.a1.ge.MSD.stableDist_param[0,0],spon_rate)
savetitle = title
...
ax1.plot([3,3],[0,np.max(np.abs(coef[1:ind_len]))],'--')
ax1.set_title('spon')
...
ax2.plot([3,3],[0,np.max(np.abs(coef[1:ind_len]))], '--')
ax2.set_title('adapt')
