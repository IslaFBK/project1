...
# -*- coding: utf-8 -*-
"""
Created on Mon Nov  2 18:19:49 2020
...
#param_in = [[0.08,6.5]]
#repeat = 10
for scale_d_p_i in np.linspace(0.85,1.15,15):
    for scale_ee_1 in [1.2]:#np.linspace(1.4,1.6,10):#[1.5]: #np.linspace(1.,1.2,5):
        for scale_ei_1 in [1.27]:#np.linspace(1.077,1.277,10):#[1.177]:#np.linspace(1,1,1):
            for scale_ie_1 in np.linspace(1.156-0.2,1.156+0.2,31):#np.linspace(1.157,1.357,10):#[1.257]: #np.linspace(0.95,1.1,5):
...
ijwd.decay_p_ie = 17.2 * scale_d_p_i#* scale_d_p # decay constant of i to e connection probability as distance increases
ijwd.decay_p_ii = 17.2 * scale_d_p_i#* scale_d_p # decay constant of i to i connection probability as distance increases

ijwd.mean_SynNumIn_ee = 200     ; # p = 0.08
ijwd.mean_SynNumIn_ei = 320 #* 8/5     ; # p = 0.125
ijwd.mean_SynNumIn_ie = 129 * scale_d_p_i    ; # p = 0.2
ijwd.mean_SynNumIn_ii = 221 * scale_d_p_i#* 8/5     ; # p = 0.25
...
#%%
mua_adpt = data1.a1.ge.spk_rate.spk_rate.reshape(3969,-1)[chg_adapt_neuron]
#%%
plt.figure()
