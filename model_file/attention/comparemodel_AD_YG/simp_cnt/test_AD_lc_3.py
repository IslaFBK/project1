...
# -*- coding: utf-8 -*-
"""
Created on Sun Nov  1 17:58:31 2020
...
ijwd.decay_p_ee = 8  * 0.82#scale_d_p # decay constant of e to e connection probability as distance increases
...
ijwd.mean_SynNumIn_ee = 220#200 320 * 6/8 * 1   ; # p = 0.08
...
scale_ee = 1.0#1.05; 
scale_ei = 1.3 #1.
scale_ie = 1.15 #1.115 1.13 0.95 1.07
...
#%%
data1.a1.ge.get_spike_rate(start_time=0, end_time=22000,\
...
ax1.set_title('spon')
coef, freq = fa.myfft(mua_adpt[4000:14000], 1000)
freq_max = 20
ind_len = freq[freq<freq_max].shape[0] 
...
findcfc.optionSur = 2
#%%
MI_raw_mat, MI_surr_mat = findcfc.find_cfc_from_rawsig(mua_adpt[4000:14000])
