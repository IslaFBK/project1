...
# -*- coding: utf-8 -*-
"""
Created on Mon Nov  2 22:40:08 2020
...
for scale_d_p_ii in [1]:#np.linspace(0.85,1.15,15):
    for scale_d_p_ie in np.linspace(0.85,1.15,13):
        for num_ii in [221]:#np.linspace(156, 297, 10,dtype=int):
            for num_ie in np.linspace(93, 177, 10,dtype=int):
...
ijwd.mean_SynNumIn_ee = 200     ; # p = 0.08
ijwd.mean_SynNumIn_ei = 320 #* 8/5     ; # p = 0.125
ijwd.mean_SynNumIn_ie = num_ie * 1 #scale_d_p_i    ; # p = 0.2
