...
# -*- coding: utf-8 -*-
"""
Created on Thu Oct 29 13:59:41 2020
...
data.a1.ge.get_MSD(start_time=1000, end_time=5000, window = 15, jump_interval=np.array([15]), fit_stableDist='pylevy')
...
''' MSD '''
data.a1.ge.get_MSD(start_time=1000, end_time=5000, window = 15, jump_interval=np.arange(1,1000,5), fit_stableDist='Matlab')
