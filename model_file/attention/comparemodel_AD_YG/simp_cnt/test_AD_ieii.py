...
# -*- coding: utf-8 -*-
"""
Created on Tue Nov 17 17:30:06 2020
                        ...
                        for num_ie in np.linspace(130,170,5, dtype=int):#[150]:#np.linspace(140,170,4):#[170]:#[260]:#np.linspace(246, 300, 6,dtype=int):#[221]:#np.linspace(156, 297, 10,dtype=int):
                            for num_ii in np.linspace(210,260,6, dtype=int):#[260]:#np.linspace(135, 170,6,dtype=int):#[129]:#np.linspace(93, 177, 10,dtype=int):
                                for w_ee_ in np.linspace(4,4,1):#np.linspace(17,23,7):#np.linspace(1.077,1.277,10):#[1.177]:#np.linspace(1,1,1):
                                    for w_ie in [None]:
                                        for ie_r_e in np.arange(2.7,3.31,0.03):#[3.1]:#np.linspace(3.10,3.45,6):#np.linspace(1.4,1.6,10):#[1.5]: #np.linspace(1.,1.2,5):
                                            for w_ei_ in [5]:#np.linspace(5,7,5):
                                                for w_ii_ in [None]:#np.linspace(20,27,8):#np.arange(1.4,1.81,0.1)]]:#np.linspace(1.,1.,1):
                                                    for ie_r_i in (ie_r_e/1.2)*np.arange(0.87,1.15,0.03):#np.arange(2.4,2.8,0.):#[2.786]:#np.linspace(2.5,3.0,15):#np.linspace(1.156-0.08,1.156+0.08,15):#np.linspace(1.156-0.175,1.156+0.175,31):#np.linspace(1.157,1.357,10):#[1.257]: #np.linspace(0.95,1.1,5):
                                                        for w_extnl_ in [1.5]:
...
ijwd1.decay_p_ie = 20 * 0.95 #* scale_d_p_ie#scale_d_p_i#* scale_d_p # decay constant of i to e connection probability as distance increases
