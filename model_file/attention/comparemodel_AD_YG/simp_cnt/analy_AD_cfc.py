...
# -*- coding: utf-8 -*-
"""
Created on Sun Nov 22 16:11:12 2020
...
dt = 1/10000;
end = int(5/dt); start = int(1/dt)
spon_rate = np.sum((data.a1.ge.t < end) & (data.a1.ge.t > start))/4/data.a1.param.Ne
...
mua_neuron_1 = cn.findnearbyneuron.findnearbyneuron(data.a1.param.e_lattice, mua_loca_n, mua_range, data.a1.param.width)
mua_loca_n = [31.5,31.5]; mua_loca.append(mua_loca_n)
mua_range = 5#6 * scale_d_p
mua_neuron_2 = cn.findnearbyneuron.findnearbyneuron(data.a1.param.e_lattice, mua_loca_n, mua_range, data.a1.param.width)


start_time = 6e3; end_time = 26e3
data.a1.ge.get_spike_rate(start_time=start_time, end_time=end_time, sample_interval=1, n_neuron = data.a1.param.Ne, window = 10)
...
for i in range(len(MI_raw_mat)):
    ...
    plt.suptitle('erie: %.3f, location: %s'%(data.a1.param.ie_r_e, mua_loca[i]))
