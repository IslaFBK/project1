...
# -*- coding: utf-8 -*-
"""
Created on Thu Nov 12 21:52:48 2020
...
ie_ratio = np.concatenate((ie_ratio_part1, ie_ratio_part2))

for scale_d_p_ee in [1]*20:#np.linspace(0.85,1.15,13):
                    ...
                    for num_ei in [400]:#np.linspace(204, 466, 10, dtype=int):#[320]:               
                        for num_ie in [150]:#[260]:#np.linspace(246, 300, 6,dtype=int):#[221]:#np.linspace(156, 297, 10,dtype=int):
                            for num_ii in [230]:#np.linspace(135, 170,6,dtype=int):#[129]:#np.linspace(93, 177, 10,dtype=int):
                                for ie_r_e in ie_ratio:#np.arange(2.70  , 3.5  , 0.01):#np.arange(2.5,4.0,0.04):#[3.1]:#np.linspace(3.10,3.45,6):#np.linspace(1.4,1.6,10):#[1.5]: #np.linspace(1.,1.2,5):
                                    for w_ee_ in [4]:
                                        for w_ie_ in [None]:#[17]:#np.linspace(17,23,7):#np.linspace(1.077,1.277,10):#[1.177]:#np.linspace(1,1,1):
                                            for ie_r_i in [2.450]:#[2.817]:#[2.786]:#np.linspace(2.5,3.0,15):#np.linspace(1.156-0.08,1.156+0.08,15):#np.linspace(1.156-0.175,1.156+0.175,31):#np.linspace(1.157,1.357,10):#[1.257]: #np.linspace(0.95,1.1,5):
