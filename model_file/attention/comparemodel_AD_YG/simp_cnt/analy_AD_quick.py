...
# -*- coding: utf-8 -*-
"""
Created on Thu Nov 19 16:22:07 2020
...
spon_rate_good = spon_rate < 9.5 and spon_rate > 3.8
...
pattern_on_ratio_good = data_anly.pattern_on_ratio > 0.1
#%%

if analy_type == 'ii':
    data_anly.invalid_pii = data.a1.param.p_peak_ii >= 1  
    title = "dpii%.3f_nii%d_ie%.3f_sz%.1f_alpha%.2f_hz%.2f"%(data.a1.param.scale_d_p_ii, data.a1.param.num_ii,\
                                                      data.a1.param.scale_ie_1, data_anly.patterns_size_mean,\
...
if analy_type == 'ie':
    ...
    title = "dpie%.3f_nie%d_ie%.3f_sz%.1f_alpha%.2f_hz%.2f"%(data.a1.param.scale_d_p_ie, data.a1.param.num_ie,\
                                                      data.a1.param.scale_ie_1, data_anly.patterns_size_mean,\
                                                      data.a1.ge.MSD.stableDist_param[0,0],spon_rate)
...
if analy_type == 'ee':
    ...
    title = "dpee%.3f_nee%d_ie%.3f_sz%.1f_alpha%.2f_hz%.2f"%(data.a1.param.scale_d_p_ee, data.a1.param.num_ee,\
                                                      data.a1.param.scale_ie_1, data_anly.patterns_size_mean,\
                                                      data.a1.ge.MSD.stableDist_param[0,0],spon_rate)
...
if analy_type == 'ei':
    ...
    title = "dpei%.3f_nei%d_ie%.3f_sz%.1f_alpha%.2f_hz%.2f"%(data.a1.param.scale_d_p_ei, data.a1.param.num_ei,\
                                                      data.a1.param.scale_ie_1, data_anly.patterns_size_mean,\
                                                      data.a1.ge.MSD.stableDist_param[0,0],spon_rate)    
...
if analy_type == 'wt':
    #data_anly.invalid_pei = data.a1.param.p_peak_ei >= 1    
    title = "ie%.1f_erie%.3f_ii%.1f_irie%.3f_\non%.2f_sz%.1f_alpha%.2f_hz%.2f"%(data.a1.param.w_ie_mean, data.a1.param.ie_r_e,\
                                                      data.a1.param.w_ii_mean, data.a1.param.ie_r_i, data_anly.pattern_on_ratio, data_anly.patterns_size_mean,\
                                                      data.a1.ge.MSD.stableDist_param[0,0],spon_rate)    
if analy_type == 'nee':
    #data_anly.invalid_pei = data.a1.param.p_peak_ei >= 1    
    title = "nee%d_erie%.3f_\non%.2f_sz%.1f_alpha%.2f_hz%.2f"%(data.a1.param.num_ee, data.a1.param.ie_r_e,\
                                                      data_anly.pattern_on_ratio, data_anly.patterns_size_mean,\
                                                      data.a1.ge.MSD.stableDist_param[0,0],spon_rate)    

if analy_type == 'nie':
    #data_anly.invalid_pei = data.a1.param.p_peak_ei >= 1    
    title = "nie%d_erie%.3f_\non%.2f_sz%.1f_alpha%.2f_hz%.2f"%(data.a1.param.num_ie, data.a1.param.ie_r_e,\
                                                      data_anly.pattern_on_ratio, data_anly.patterns_size_mean,\
                                                      data.a1.ge.MSD.stableDist_param[0,0],spon_rate)    

if analy_type == 'nii':
    #data_anly.invalid_pei = data.a1.param.p_peak_ei >= 1    
    title = "nii%d_irie%.3f_\non%.2f_sz%.1f_alpha%.2f_hz%.2f"%(data.a1.param.num_ii, data.a1.param.ie_r_i,\
                                                      data_anly.pattern_on_ratio, data_anly.patterns_size_mean,\
                                                      data.a1.ge.MSD.stableDist_param[0,0],spon_rate)    

if analy_type == 'nei':
    #data_anly.invalid_pei = data.a1.param.p_peak_ei >= 1    
    title = "nei%d_irie%.3f_\non%.2f_sz%.1f_alpha%.2f_hz%.2f"%(data.a1.param.num_ei, data.a1.param.ie_r_i,\
                                                      data_anly.pattern_on_ratio, data_anly.patterns_size_mean,\
                                                      data.a1.ge.MSD.stableDist_param[0,0],spon_rate)    

if analy_type == 'wt2':
    #data_anly.invalid_pei = data.a1.param.p_peak_ei >= 1    
    title = "erie%.3f_irie%.3f_\non%.2f_sz%.1f_alpha%.2f_hz%.2f"%(data.a1.param.ie_r_e,\
                                                      data.a1.param.ie_r_i, data_anly.pattern_on_ratio, data_anly.patterns_size_mean,\
                                                      data.a1.ge.MSD.stableDist_param[0,0],spon_rate)    
if analy_type == 'ie_hz':
    #data_anly.invalid_pei = data.a1.param.p_peak_ei >= 1    
    title = "erie%.3f_\non%.2f_sz%.1f_alpha%.2f_hz%.2f"%(data.a1.param.ie_r_e,\
...
if analy_type == '5ms':
    #data_anly.invalid_pei = data.a1.param.p_peak_ei >= 1    
    title = "nee%d_nii%d_erie%.3f_irie%.3f_\non%.2f_sz%.1f_alpha%.2f_hz%.2f"%(data.a1.param.num_ee, data.a1.param.num_ii,\
                                                      data.a1.param.ie_r_e, data.a1.param.ie_r_i, data_anly.pattern_on_ratio, data_anly.patterns_size_mean,\
                                                      data.a1.ge.MSD.stableDist_param[0,0],spon_rate)    
 
if analy_type == 'eeie':
    #data_anly.invalid_pei = data.a1.param.p_peak_ei >= 1    
    title = "nee%d_nie%d_erie%.3f_irie%.3f_\non%.2f_sz%.1f_alpha%.2f_hz%.2f"%(data.a1.param.num_ee, data.a1.param.num_ie,\
                                                      data.a1.param.ie_r_e, data.a1.param.ie_r_i, data_anly.pattern_on_ratio, data_anly.patterns_size_mean,\
                                                      data.a1.ge.MSD.stableDist_param[0,0],spon_rate)    

if analy_type == 'ei_n':
    #data_anly.invalid_pei = data.a1.param.p_peak_ei >= 1    
    title = "erie%.3f_irie%.3f_wei%.2f_\non%.2f_sz%.1f_alpha%.2f_hz%.2f"%(data.a1.param.ie_r_e, data.a1.param.ie_r_i, \
                                                                          data.a1.param.w_ei_mean, data_anly.pattern_on_ratio, data_anly.patterns_size_mean,\
                                                      data.a1.ge.MSD.stableDist_param[0,0],spon_rate)    
if analy_type == 'ee_n':
    #data_anly.invalid_pei = data.a1.param.p_peak_ei >= 1    
    title = "erie%.3f_irie%.3f_wee%.2f_\non%.2f_sz%.1f_alpha%.2f_hz%.2f"%(data.a1.param.ie_r_e, data.a1.param.ie_r_i, \
                                                                          data.a1.param.w_ee_mean, data_anly.pattern_on_ratio, data_anly.patterns_size_mean,\
                                                      data.a1.ge.MSD.stableDist_param[0,0],spon_rate)    

if analy_type == 'eiii':
    #data_anly.invalid_pei = data.a1.param.p_peak_ei >= 1    
    title = "erie%.3f_irie%.3f_nii%d_nei%d_\non%.2f_sz%.1f_alpha%.2f_hz%.2f"%(data.a1.param.ie_r_e, data.a1.param.ie_r_i, \
                                                                          data.a1.param.num_ii, data.a1.param.num_ei,data_anly.pattern_on_ratio, data_anly.patterns_size_mean,\
                                                      data.a1.ge.MSD.stableDist_param[0,0],spon_rate)    

if analy_type == 'ieii':
    #data_anly.invalid_pei = data.a1.param.p_peak_ei >= 1    
    title = "erie%.3f_irie%.3f_nie%d_nii%d_\non%.2f_sz%.1f_alpha%.2f_hz%.2f"%(data.a1.param.ie_r_e, data.a1.param.ie_r_i, \
                                                                          data.a1.param.num_ie, data.a1.param.num_ii,data_anly.pattern_on_ratio, data_anly.patterns_size_mean,\
                                                      data.a1.ge.MSD.stableDist_param[0,0],spon_rate)    
...
ind_len = freq[freq<freq_max].shape[0] # int(20/(fs/2)*(len(data_fft)/2)) + 1
#ax1t=ax1.twinx()
im3 = ax3.plot(freq[1:ind_len], np.abs(coef[1:ind_len]),'tab:orange',label='adapt')
ax3.plot([3,3],[0,np.max(np.abs(coef[1:ind_len]))],'r--')
ax3.plot([8,8],[0,np.max(np.abs(coef[1:ind_len]))],'r--')
ax4.loglog(freq[1:ind_len], np.abs(coef[1:ind_len]),'tab:orange',label='adapt_log')
ax4.loglog([3,3],[0,np.max(np.abs(coef[1:ind_len]))],'r--')
ax4.loglog([8,8],[0,np.max(np.abs(coef[1:ind_len]))],'r--')
plt.legend()
#lms = im1 + im2
...
ani = firing_rate_analysis.show_pattern(data.a1.ge.spk_rate.spk_rate, None, frames = frames, start_time = start_time, \
...
'''move good results'''
if spon_rate_good and stable_good and peakF_good and pattern_on_ratio_good:
