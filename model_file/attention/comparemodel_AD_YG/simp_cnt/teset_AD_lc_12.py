...
# -*- coding: utf-8 -*-
"""
Created on Tue Nov 17 23:30:29 2020
...
ijwd1.decay_p_ie = 20*0.9 #* scale_d_p_ie#scale_d_p_i#* scale_d_p # decay constant of i to e connection probability as distance increases
ijwd1.decay_p_ii = 20*0.95 #* scale_d_p_ii#* scale_d_p # decay constant of i to i connection probability as distance increases

ijwd1.mean_SynNumIn_ee = num_ee     ; # p = 0.08
ijwd1.mean_SynNumIn_ei = num_ei #* 8/5     ; # p = 0.125
ijwd1.mean_SynNumIn_ie = num_ie -10  #scale_d_p_i    ; # p = 0.2
ijwd1.mean_SynNumIn_ii = num_ii -10# 221 * scale_d_p_i#* 8/5     ; # p = 0.25
...
if all_run:
    group_e_1.delta_gk[chg_adapt_neuron] = 2.4*nS
...
coef, freq = fa.myfft(fft_data[4000:12000], 1000)
freq_max = 20
