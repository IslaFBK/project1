...
# -*- coding: utf-8 -*-
"""
Created on Mon Oct 19 11:58:14 2020
...
#datapath = '/run/user/719/gvfs/smb-share:domain=mcs,server=shared.sydney.edu.au,share=research-data,user=shni2598/PRJ-THAP/shencong/attention/chg_netsize_tauk/'
#datapath = '/run/user/719/gvfs/smb-share:server=shared.sydney.edu.au,share=research-data/PRJ-THAP/shencong/attention/chg_netsize_tauk/'
datapath = ''
...
#title = "dgk{:.1f}_ndgk{:.1f}_alpha{:.2f}".format(data.a1.param.delta_gk,data.a1.param.new_delta_gk,data.a1.ge.MSD.stableDist_param[0,0])
title = "ie%.3f_dgk%.1f_ndgk%.2f_tauk%.1f_alpha%.2f_hz%.2f"%(data.a1.param.scale_ie_1, data.a1.param.delta_gk, data.a1.param.new_delta_gk, data.a1.param.tau_k, data.a1.ge.MSD.stableDist_param[0,0], spon_rate)
