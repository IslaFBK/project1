...
# -*- coding: utf-8 -*-
"""
Created on Tue Oct 13 18:46:16 2020
...
for scale_ee_1 in [1.15]: #np.linspace(1.,1.2,5):
    for scale_ei_1 in np.linspace(1,1,1):
        for scale_ie_1 in [1.0625]: #np.linspace(0.95,1.1,5):
            for scale_ii_1 in np.linspace(1.,1.,1):
                for w_extnl_ in [1.5]:
                    for delta_gk_ in np.linspace(3,12,10):
                        for tau_s_di_ in np.linspace(3,5.5,8):
                            for tau_s_de_ in np.linspace(4.6,6.1,6):
                                for tau_s_r_ in np.arange(0.3,1.01,0.1):
...
ijwd.decay_p_ie = decay_p_ie_p_ii # decay constant of i to e connection probability as distance increases
ijwd.decay_p_ii = decay_p_ie_p_ii # decay constant of i to i connection probability as distance increases
...
syn_ii_1.w = ijwd.w_ii*nsiemens/tau_s_r_ * 6. #tau_s_di_#25*nS
syn_ie_1.w = ijwd.w_ie*nsiemens/tau_s_r_ * 6. #tau_s_di_#
#w_ext = 2*nS
#syn_pois_e.w = w_ext
#syn_pois_i.w = w_ext
#u_base = 0.3
