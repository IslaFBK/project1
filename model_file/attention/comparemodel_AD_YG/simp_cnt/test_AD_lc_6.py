...
# -*- coding: utf-8 -*-
"""
Created on Sun Nov  8 21:04:21 2020
...
scale_ee = 1.1#1.05;                                                                
scale_ei = 1 #1.
scale_ie = 0.95 *0.94 #1.115 1.13 0.95 1.07                           #0.87
...
group_e_1.tau_s_de = 4.0*ms
group_i_1.tau_s_de = 4.0*ms
...
#%%
data1.a1.ge.get_spike_rate(start_time=0, end_time=20000,\
