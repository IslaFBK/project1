...
# -*- coding: utf-8 -*-
"""
Created on Mon Oct 26 14:05:15 2020
...
for scale_ee_1 in [1.15]:#np.arange(1.4,1.71,0.1): #np.linspace(1.,1.2,5):
                    ...
                    for delta_gk_ in [3,7,10]:#[14]:#np.linspace(7,15,9):
                        for tau_k_ in [90]:#np.arange(40,121,10): 
                            for new_delta_gk_ in [delta_gk_]:#[14]:#np.arange(0.15,0.31,0.05)*delta_gk_: #np.linspace(1,5,5):
                                for tau_s_di_ in np.arange(3,6.7,0.3):#np.linspace(4.444,4.444,1):
