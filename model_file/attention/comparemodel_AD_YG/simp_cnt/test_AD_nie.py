...
# -*- coding: utf-8 -*-
"""
Created on Tue Nov 10 22:36:31 2020
            ...
            for scale_d_p_ie in np.linspace(1,1,1):#np.linspace(0.85,1.15,13):
                for num_ee in [260]:#np.linspace(220,290,8):#[260]:#np.linspace(125, 297, 10,dtype=int): 
                    for num_ei in [400]:#np.linspace(204, 466, 10, dtype=int):#[320]:               
                        for num_ie in np.linspace(145,205,7):#[175]:#[260]:#np.linspace(246, 300, 6,dtype=int):#[221]:#np.linspace(156, 297, 10,dtype=int):
                            for num_ii in [260]:#np.linspace(135, 170,6,dtype=int):#[129]:#np.linspace(93, 177, 10,dtype=int):
                                for w_ee_ in [4.15]:
                                    for ie_r_e in np.arange(3.05,3.36,0.05):#np.linspace(1.4,1.6,10):#[1.5]: #np.linspace(1.,1.2,5):
