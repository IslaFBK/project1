...
# -*- coding: utf-8 -*-
"""
Created on Thu Oct  1 10:39:27 2020
...
for scale_ee_1 in np.linspace(0.9,1.2,10):
    for scale_ei_1 in np.linspace(1,1,1):
        for scale_ie_1 in np.linspace(0.9,1.2,10):
            for scale_ii_1 in np.linspace(1.,1.,1):
                for w_extnl_ in [1.5]:
                    for delta_gk_ in np.linspace(2,15,14):
