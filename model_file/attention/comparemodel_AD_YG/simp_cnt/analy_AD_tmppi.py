...
# -*- coding: utf-8 -*-
"""
Created on Thu Nov  5 12:11:15 2020
...
spon_rate_good = spon_rate < 10 and spon_rate > 3
'''MSD'''
...
if analy_type == 'adapt':
    title = "dgk%.1f_tauk%.1f_ie%.3f_alpha%.2f_hz%.2f"%(data.a1.param.delta_gk, data.a1.param.tau_k,\
                                                      data.a1.param.scale_ie_1,\
                                                      data.a1.ge.MSD.stableDist_param[0,0],spon_rate)  
if analy_type == 'piepii':
    data_anly.invalid_pie = data.a1.param.p_peak_ie >= 1
    data_anly.invalid_pii = data.a1.param.p_peak_ii >= 1    
    title = "dpii%.3f_dpie%.3f_nii%d_\nnie%d_ie%.3f_alpha%.2f_hz%.2f"%(data.a1.param.scale_d_p_ii, data.a1.param.scale_d_p_ie,\
                                                              data.a1.param.num_ii, data.a1.param.num_ie,
                                                              data.a1.param.scale_ie_1,\
                                                      data.a1.ge.MSD.stableDist_param[0,0],spon_rate)
    if data_anly.invalid_pie: title = 'p_'+title
    if data_anly.invalid_pii: title = 'p_'+title
