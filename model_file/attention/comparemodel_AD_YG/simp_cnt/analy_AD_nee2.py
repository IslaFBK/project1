...
# -*- coding: utf-8 -*-
"""
Created on Wed Nov 11 18:07:00 2020
...
if analy_type == 'dgkS':
    #data_anly.invalid_pei = data.a1.param.p_peak_ei >= 1    
    title = "dse%.3f_dsi%.3f_erie%.3f_irie%.3f_\non%.2f_sz%.1f_alpha%.2f_hz%.2f"%(data.a1.param.tau_s_de, data.a1.param.tau_s_di, data.a1.param.ie_r_e,\
                                                      data.a1.param.ie_r_i, data_anly.pattern_on_ratio, data_anly.patterns_size_mean,\
                                                      data.a1.ge.MSD.stableDist_param[0,0],spon_rate)    

if analy_type == 'dgk':
    #data_anly.invalid_pei = data.a1.param.p_peak_ei >= 1    
    title = "dgk%.1f_erie%.3f_irie%.3f_\non%.2f_sz%.1f_alpha%.2f_hz%.2f"%(data.a1.param.delta_gk, data.a1.param.ie_r_e,\
                                                      data.a1.param.ie_r_i, data_anly.pattern_on_ratio, data_anly.patterns_size_mean,\
                                                      data.a1.ge.MSD.stableDist_param[0,0],spon_rate)    
