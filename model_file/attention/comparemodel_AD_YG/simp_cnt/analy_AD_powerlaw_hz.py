...
# -*- coding: utf-8 -*-
"""
Created on Mon Oct 26 15:11:10 2020
...
#title = "d%.2f_dsi%.2f_dse%.2f_alpha%.2f_hz%.2f"%(data.a1.param.delay, data.a1.param.tau_s_di,data.a1.param.tau_s_de, data.a1.ge.MSD.stableDist_param[0,0], spon_rate)
#title = "ee%.2f_ei%.2f_ie%.3f_ii%.2f_alpha%.2f_hz%.2f"%(data.a1.param.scale_ee_1, data.a1.param.scale_ei_1,data.a1.param.scale_ie_1,data.a1.param.scale_ii_1, data.a1.ge.MSD.stableDist_param[0,0], spon_rate)
#title = "ie%.3f_dsi%.3f_alpha%.2f_hz%.2f"%(data.a1.param.scale_ie_1, data.a1.param.tau_s_di, data.a1.ge.MSD.stableDist_param[0,0], spon_rate)
title = "ie%.3f_dsi%.3f_dgk%.1f_alpha%.2f_hz%.2f"%(data.a1.param.scale_ie_1, data.a1.param.tau_s_di, data.a1.param.delta_gk, data.a1.ge.MSD.stableDist_param[0,0], spon_rate)
...
#title = "ei%.3f_ii%.3f_dgk%.1f_ndgk%.2f_alpha%.2f"%(data.a1.param.scale_ei_1, data.a1.param.scale_ii_1, data.a1.param.delta_gk, data.a1.param.new_delta_gk, data.a1.ge.MSD.stableDist_param[0,0])
#title = "ee%.3f_ie%.3f_dgk%.1f_ndgk%.2f_alpha%.2f"%(data.a1.param.scale_ee_1, data.a1.param.scale_ie_1, data.a1.param.delta_gk, data.a1.param.new_delta_gk, data.a1.ge.MSD.stableDist_param[0,0])
#title = "ie%.2f_dsi%.2f_dse%.2f_alpha%.2f"%(data.a1.param.scale_ie_1, data.a1.param.tau_s_di,data.a1.param.tau_s_de, data.a1.ge.MSD.stableDist_param[0,0])
#title = "d%.2f_dsi%.2f_dse%.2f_alpha%.2f"%(data.a1.param.delay, data.a1.param.tau_s_di,data.a1.param.tau_s_de, data.a1.ge.MSD.stableDist_param[0,0])
#title = "d%.2f_dsi%.2f_dse%.2f_alpha%.2f_hz%.2f"%(data.a1.param.delay, data.a1.param.tau_s_di,data.a1.param.tau_s_de, data.a1.ge.MSD.stableDist_param[0,0], spon_rate)
#title = "ee%.2f_ei%.2f_ie%.2f_alpha%.2f_hz%.2f"%(data.a1.param.scale_ee_1, data.a1.param.scale_ei_1,data.a1.param.scale_ie_1, data.a1.ge.MSD.stableDist_param[0,0], spon_rate)
#title = "ee%.2f_ei%.2f_ie%.2f_ii%.2f_alpha%.2f_hz%.2f"%(data.a1.param.scale_ee_1, data.a1.param.scale_ei_1,data.a1.param.scale_ie_1,data.a1.param.scale_ii_1, data.a1.ge.MSD.stableDist_param[0,0], spon_rate)
savetitle = title
...
#data_anly.spon_pf_mag = np.abs(coef[1:]).max()
#data_anly.spon_pf = freq[1:][np.abs(coef[1:]).argmax()]
...
#data_anly.adapt_pf_mag = np.abs(coef[1:]).max()
#data_anly.adapt_pf = freq[1:][np.abs(coef[1:]).argmax()]
...
''' MSD '''
title = "ee%.2f_ei%.2f_ie%.3f_ii%.2f_hz%.2f"%(data.a1.param.scale_ee_1, data.a1.param.scale_ei_1,data.a1.param.scale_ie_1,data.a1.param.scale_ii_1, spon_rate)
savetitle = title
data.a1.ge.get_MSD(start_time=4000, end_time=20000, n_neuron = data.a1.param.Ne, window = 15, jump_interval=np.arange(1,1000,5), fit_stableDist='Matlab')
