...
# -*- coding: utf-8 -*-
"""
Created on Tue Aug  4 22:58:06 2020
...
'''
Adam neuron model
Set the network to be able to produce plane wave at low ie_ratio.
'''
...
for p_ee in [0.16]*10: 
    for tau_s_di_ in np.linspace(3, 3, 1):
        for delta_gk_ in np.linspace(10, 10, 1):
            for t_ref in np.linspace(5.5,5.5,1)*ms:
