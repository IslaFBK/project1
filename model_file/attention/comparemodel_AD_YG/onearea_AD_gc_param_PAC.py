...
# -*- coding: utf-8 -*-
"""
Created on Fri Aug 21 10:44:40 2020

@author: shni2598
"""

'''
Adam neuron model, calculate PAC
'''
...
for p_ee in [0.08]*repeat:
    for tau_s_di_ in [6.5]:
        for scale_ee_ in [0.85+0.3/9]: #np.arange(1,2):
            for delta_gk_ in [3]: #np.arange(2, 8):
                for tau_s_de_ in [5.8]:
                    for ie_ratio_ in [3.375*1.04]: #np.arange(0.94, 1.21, 0.02):#np.linspace(2.4, 4.5, 20):
                        loop_num += 1
