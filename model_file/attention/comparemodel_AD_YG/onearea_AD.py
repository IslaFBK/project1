# -*- coding: utf-8 -*-
"""
Created on Mon Aug  3 11:19:53 2020
...
for p_ee, tau_s_di_ in param_in:
    for scale_ee_1 in np.linspace(0.7,1.1,10):
        for ie_ratio_ in np.linspace(2.4, 4.5, 20):
            loop_num += 1
...
syn_ii_1.w = ijwd.w_ii*usiemens * tau_s_di_try#25*nS
syn_ie_1.w = ijwd.w_ie*usiemens * tau_s_di_try
#w_ext = 2*nS
#syn_pois_e.w = w_ext
#syn_pois_i.w = w_ext
#%%
