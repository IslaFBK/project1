...
# -*- coding: utf-8 -*-
"""
Created on Fri Aug 14 15:39:20 2020
...
for p_ee in [0.08]*repeat:
    for tau_s_di_ in [6.5]:
        for scale_ee_ei_ii in np.arange(1,2):
            for delta_gk_ in np.arange(2, 8):
                for tau_s_de_ in [5.8]:
                    for ie_ratio_ in 3.375*np.arange(0.94, 1.21, 0.02):#np.linspace(2.4, 4.5, 20):
                        loop_num += 1
...
scale_ee_1 = 1;#scale_ee_ei_ii; 
scale_ei_1 = 1#scale_ee_ei_ii; 
scale_ii_1 = scale_ee_ei_ii
...
w_extnl_ = 1.5 # nS
syn_extnl_e.w = w_extnl_*tau_s_de_*nS
syn_extnl_i.w = w_extnl_*tau_s_de_*nS
#%%
LFP_recordneuron = '''
lfp1 : amp
lfp2 : amp
...
syn_ee_1.w = ijwd.w_ee*usiemens * tau_s_de_
syn_ei_1.w = ijwd.w_ei*usiemens * tau_s_de_ #5*nS
syn_ii_1.w = ijwd.w_ii*usiemens * tau_s_di_#25*nS
syn_ie_1.w = ijwd.w_ie*usiemens * tau_s_di_#
#w_ext = 2*nS
#syn_pois_e.w = w_ext
#syn_pois_i.w = w_ext
#%%
