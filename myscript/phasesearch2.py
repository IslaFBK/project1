...
for arr in params_loop.values():
    loop_total *= len(arr)
# initialization looping number
loop_num = 0
#%% ready to loop
# create analyzer outside to avoid refresh the analyzer
...
#         save_path=f'./{graph_dir}/trajectory/trajectory_{common_path}.png'
#     )
...
#         'r2_spike': r2_spike
#     }
#     Analyzer.states_collector(params=params_temp, states=states_temp)
...
# )
# print(f'Phase graph of {loop_total} states saved to ./phasesearch2/{fixed_path}')